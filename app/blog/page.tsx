          ...
          <Reveal key={post.slug} delay={0.04 * i}>
            ...
            >
              ...
              <div>
                ...
                <h2 className="mt-2 text-xl font-semibold tracking-tight text-ink-50 transition-colors group-hover:text-emerald-200 md:text-2xl">
                  {post.title}
                </h2>
              ...
              <div className="flex items-center gap-3 md:flex-col md:items-end md:gap-2">
                ...
                <span className="inline-flex size-9 items-center justify-center rounded-full border border-white/10 bg-white/[0.03] text-ink-300 transition-all duration-300 group-hover:border-emerald-400/40 group-hover:bg-emerald-400/10 group-hover:text-emerald-200">
                  <ArrowUpRight
                    weight="bold"
